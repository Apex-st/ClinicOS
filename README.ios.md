...
Это **та же программа**, что Android-версия **2.34**: запись, карточки, зубная формула, фотоархив, планы, касса, скидки, резервная копия, шифрование данных, общая папка Google Диска.

Идентификатор приложения: `ru.denta.clinic`  
Версия: **2.34** (build 53)
