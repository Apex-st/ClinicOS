...
Это **та же программа**, что Android-версия **2.26**: запись, карточки, зубная формула (постоянный и молочный прикус), фотоархив, планы, касса, скидки, резервная копия.

Идентификатор приложения: `ru.denta.clinic`  
Версия: **2.26** (build 46)
