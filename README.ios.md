...
Это **та же программа**, что Android-версия **2.33**: запись, карточки, зубная формула, фотоархив, планы, касса, скидки, резервная копия, шифрование данных, общая папка Google Диска.

Идентификатор приложения: `ru.denta.clinic`  
Версия: **2.33** (build 52)
Название на телефоне: **ClinicOS**
...
На iPhone тестировщика: установить **TestFlight** → принять приглашение → Установить «ClinicOS».
