...
Это **та же программа**, что Android-версия **2.32**: запись, карточки, зубная формула, фотоархив, планы, касса, скидки, резервная копия, шифрование данных.

Идентификатор приложения: `ru.denta.clinic`  
Версия: **2.32** (build 51)
