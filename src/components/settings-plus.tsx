  ...
  return (
    <section className="rounded-xl bg-surface p-5 shadow-[var(--shadow-card)]">
      ...
      <p className="mt-4 max-w-prose text-sm text-muted">
        Данные хранятся на этом устройстве в зашифрованном виде (AES-256): карточки — в защищённом хранилище программы,
        фото — отдельно, тоже закрытые ключом. Сервера синхронизации нет. Копия кабинета — файл .denta в «Настройки →
        Резервная копия». Живое соединение между копиями не имитируется. Автопроверки обновлений нет — новой версии ждут
        с новой сборки.
      </p>
